...
public class Action_Booklist_list implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<VO_BookList> best_list_2page = dao.booklistBestsellers_2page();
		List<VO_BookList> best_list_3page = dao.booklistBestsellers_3page();
		...
		request.setAttribute("best_list_2page", best_list_2page);
		request.setAttribute("best_list_3page", best_list_3page);
		// 페이지 스킵 처리
