...
import com.library.action.admin.Action_Admin_Calendar_Insert;
import com.library.action.admin.Action_Admin_Calendar_Insert_Pro;
...
public class ActionFactory_Admin implements ActionFactory {
	...
	public Action getAction(String cmd) {
		...
		} else if (cmd.equals("admin_calander_insert")) {
			action = new Action_Admin_Calendar_Insert();
		} else if (cmd.equals("admin_calander_insert_pro")) {
			action = new Action_Admin_Calendar_Insert_Pro();
		}
		return action;
	}
}