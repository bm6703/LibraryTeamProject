...
import com.library.action.booklist.Action_Booklist_Genre_Add;
import com.library.action.booklist.Action_Booklist_Genre_Add_Pro;
import com.library.action.booklist.Action_Booklist_delete;
import com.library.action.booklist.Action_Booklist_down;
...
public class ActionFactory_booklist implements ActionFactory {
	...
	public Action getAction(String cmd) {
		...
		} else if (cmd.equals("booklist_down")) {
			action = new Action_Booklist_down();
		} else if (cmd.equals("booklist_genre_add")) {
			action = new Action_Booklist_Genre_Add();
		} else if (cmd.equals("booklist_genre_add_pro")) {
			action = new Action_Booklist_Genre_Add_Pro();
		}
		return action;
	}
}