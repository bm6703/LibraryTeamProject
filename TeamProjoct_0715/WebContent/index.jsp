...
<div class="ka">
	...
	<div class="itemi" style="margin-top: 500px;">
		<ul id="content-slider" class="content-slider">
			<c:forEach var="best" items="${blist}">
				<li>
					<a href="booklist?cmd=booklist_view&bookno=${best.bookno}" style="color:black;">
						<img src="img/${best.bookimg}" alt="" class="bookimg">
					</a>
				</li>
			</c:forEach>
		</ul>
