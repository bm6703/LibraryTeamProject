       ...
       <div class="check_font" id="pw_check"></div>
        ...
        <div class="form-group">
          ...
          <input type="password" placeholder="Enter repasswd" id="repwd" name="repasswd"  oninput="checkPwd()" required="required"/>
        	...
        	<button type=button name="authbtn" class="btn btn-outline-primary" onclick="checkatn()" style="margin-top: 23px;">인증하기</button>
       <div class="form-group">
       
                 <label for="phone" style="clear: both;">Phone</label>
...
<!--       <button type=button name="authbtn" class="btn btn-outline-primary" onclick="checkatn()" style="width: 15%;float: left;">인증하기</button>  -->
